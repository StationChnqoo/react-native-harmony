...
var Gradient = [
  { name: "Meihong", value: "魅红", start: "#ef2c8c", end: "#f63c3d" },
  { name: "Liujin", value: "鎏金", start: "#f69716", end: "#f02324" },
  { name: "Cuiliu", value: "翠柳", start: "#8dc642", end: "#3cb54b" },
  { name: "Dianqin", value: "靛青", start: "#1cbaba", end: "#0282fe" },
  { name: "Huozi", value: "惑紫", start: "#9237ff", end: "#6034fe" },
  { name: "Xiacai", value: "霞彩", start: "#ec2c8e", end: "#6b36b9" },
];
